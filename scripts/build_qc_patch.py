...
FILES = [
    ...
    "qc_viewer.py",
    "qc_assist.py",
    "docs/protocol_assisted_qc.md",
    "docs/protocol_assisted_qc_verification.md",
    "src/gb_dicom2bids/qc_protocols.py",
    "src/gb_dicom2bids/qc_features.py",
    "src/gb_dicom2bids/qc_learning.py",
    "src/gb_dicom2bids/qc_assist.py",
    "src/gb_dicom2bids/qc_web/assist.js",
    ...
    "tests/test_qc_assist.py",
    "scripts/make_assist_demo.py",
    "scripts/check_assist_browser.py",
